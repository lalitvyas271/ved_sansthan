...
function Header() {
  return (
    <header>
            <div id="header1" classNameName="header1-area">
                <div className="main-menu-area bg-primary" id="sticker">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-2 col-md-3">
                                <div className="logo-area">
                                    <a href="index.html"><img className="img-responsive" src="img/logo.png" alt="logo"/></a>
                                </div>
                            </div>
                                ...
                                <nav id="desktop-nav">
                                    <ul>
                                        <li className="active"><a href="#">Home</a>
                                            <ul>
                                                <li className="active"><a href="index.html">Home 1</a></li>
                                        ...
                                        <li><a href="#">News</a>
                                            <ul>
                                                <li className="has-child-menu"><a href="#">News</a>
                                                ...
                                                <li className="has-child-menu"><a href="#">Event</a>
                                                    <ul className="thired-level">
